...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      updateTitle(selectedIndex.value)
    })

    watch(selectedIndex, updateTitle)
  ...
  template: `
    <div class="meetup-selector">
      <div class="meetup-selector__control">
        <button class="button button--secondary" type="button" :disabled="selectedIndex <= 1" @click="selectedIndex--">
          Предыдущий
        </button>
        ...
        <button class="button button--secondary" type="button" :disabled="selectedIndex >= 5" @click="selectedIndex++">
          Следующий
        </button>
      </div>
